...
- [Testing Guide for REST API Assignment](#testing-guide-for-rest-api-assignment)
  - [Base URL](#base-url)
  - [1. Vendors Collection](#1-vendors-collection)
    - [GET /vendors](#get-vendors)
  - [2. Vendor Singleton](#2-vendor-singleton)
  - [3. Switches Sub-Collection](#3-switches-sub-collection)
    - [GET/vendors/{vendor\_id}/switches](#getvendorsvendor_idswitches)
  - [4. Keyboards Collection](#4-keyboards-collection)
    - [GET /keyboards](#get-keyboards)
  - [5. Keyboard Singleton](#5-keyboard-singleton)
    - [GET /keyboards/{keyboard\_id}](#get-keyboardskeyboard_id)
  - [6. Layout Keyboards Sub-Collection](#6-layout-keyboards-sub-collection)
    - [GET /layouts/{layout\_id}/keyboards](#get-layoutslayout_idkeyboards)
  - [7. Layout Keycap Sets Sub-Collection](#7-layout-keycap-sets-sub-collection)
    - [GET /layout/{layout\_id}/keycap-sets](#get-layoutlayout_idkeycap-sets)
  - [8. Mice Collection](#8-mice-collection)
    - [GET /mice](#get-mice)
  - [9. Mouse Buttons Sub-Collection](#9-mouse-buttons-sub-collection)
    - [GET /mice/{mouse\_id}/buttons](#get-micemouse_idbuttons)
  - [10. Testing Sort With Keyboards](#10-testing-sort-with-keyboards)
  - [11. Testing sort with Vendors](#11-testing-sort-with-vendors)
